...
RSpec.describe MetaStruct::Graph::Node do
  ...
  describe 'creation' do
    ...
    describe 'node instance final creation' do
      specify 'default node state (creation without attribute substitution)' do
        node = MetaStruct::Graph::Node.create
      ...
      specify 'common node creation (with attribute population)' do
